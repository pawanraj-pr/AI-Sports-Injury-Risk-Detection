...
from .routers import auth, athletes, videos, admin
...
app = FastAPI(
    ...
    description="Milestones 1-4: Auth & RBAC, Pose Estimation & Biomechanics, "
                "Injury Risk Prediction, Admin & Team Dashboards",
    version="0.4.0",
)
